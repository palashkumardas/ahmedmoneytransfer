...
<head>
  ...
  <title>Ahamed Money Transfer</title>
  <meta content="description" name="Barakah">
  <meta content="author" name="Muhammad Ibrahim Bin Karim || www.devsstream.com">
  <meta content="keyword" name="Barakah">

  <!-- Favicons -->
  <link href="{{ asset('fontend/assets/img/barakah/favicon.png')}}" rel="icon">
  <link href="{{ asset('fontend/assets/img/barakah/favicon.png')}}" rel="apple-touch-icon">
  ...
  <header id="header" class="header fixed-top" data-scrollto-offset="0">
    <div class="container-fluid d-flex align-items-center justify-content-between">
      ...
      <a href="{{ url('/') }}" class="logo d-flex align-items-center scrollto me-auto me-lg-0">
        ...
        <img src="{{ asset('fontend/assets/img/barakah/logoblack.png')}}" alt="">
      ...
      <nav id="navbar" class="navbar">
       ...
       <!-- <a class="btn-getstarted scrollto d-none d-md-block" href="http://worldwide.ahmedmoneytransfer.co.uk/">Login/Register</a> -->

       <p class="btn-getstarted scrollto d-none d-md-block mt-3"><span><a  class="text-white" href="http://worldwide.ahmedmoneytransfer.co.uk/">Login/</a><a  class="text-white" href="#">Register</a></span></p>
